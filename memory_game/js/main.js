...
var checkForMatch = function(cid) {
	var flippedCardDiv = document.getElementById(cid);
	flippedCardDiv.setAttribute('src', cards[cid].cardImage);
	// this.setAttribute('src', cards[cid].cardImage);
